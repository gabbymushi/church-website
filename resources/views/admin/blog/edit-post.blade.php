            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('news.update',[$news->id])}}" class="" enctype="multipart/form-data">
                            @csrf
                            <div class="position-relative form-group">
                                <label for="title" class="">Title</label>
                                <input name="title" value="{{$news->title}}" id="title" placeholder="News Title" type="text" class="form-control">
                            </div>
                            <div class="position-relative form-group">
