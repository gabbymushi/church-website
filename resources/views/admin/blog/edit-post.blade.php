            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/blog/update/{{$post->id}}" class="" enctype="multipart/form-data">
                            
                            @csrf
                            <div class="position-relative form-group">
                                <label for="title" class="">Title</label>
                                <input name="title" id="title" placeholder="News Title" value="{{$post->title}}" type="text" class="form-control">
                            </div>
                            <div class="position-relative form-group">
