...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Sharika
                <div class="page-title-subheading">Add Usharika
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/sharika/store" class="" enctype="multipart/form-data">
                            @csrf
             ...
             -->
                            <div class="position-relative form-group">
                                ...
                                <select class="form-control" name="jimbo_id" id="jimbo_id">
                                    ...
                                    @endforeach
                                    @else
                                    <option value="">Please Create Majimbo first</option>
                                    @endif
