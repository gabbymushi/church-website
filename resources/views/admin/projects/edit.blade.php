...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Project
                <div class="page-title-subheading">Edit Peoject
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/project/update/{{$project->id}}" class="" enctype="multipart/form-data">
                            @csrf
                            <div class="position-relative form-group">
                                <label for="name" class="">Name</label>
                                <input name="name" id="name" value="{{$project->name}}" placeholder="Name" type="text" class="form-control" required="required">
                            </div>
                            <!-- <div class="position-relative form-group">
