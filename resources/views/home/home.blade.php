  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 notice-bar-event-title">
        ...
        <span class="meta-data">13th July, 2015</span>
      </div>
              ...
              <ul>
                ...
                <li class="item event-item">
                  ...
                  <div class="event-detail">
                    ...
                    <span class="event-dayntime meta-data">{{$date}}</span>
                  </div>
          ...
          <div class="listing post-listing">
            ...
            <section class="listing-cont">
              <ul>
                ...
                <li class="item post">
                  <div class="row">
                    <div class="col-md-4"> <a href="{{url('/blog/'.$news->id)}}" class="media-box">
                        @if(!empty($news->files))
                        <img src="{{asset('assets/images/blog/'.$news->files[0]['name'])}}" alt="" class="img-thumbnail">
                        @else <p>No image</p>
                        @endif
                    ...
                    <div class="col-md-8">
                      <div class="post-title">
                        ...
                        <span class="meta-data"><i class="fa fa-calendar"></i> on {{date('jS F,Y',strtotime($news->created_at))}}</span>
                      </div>
                      {!!$news->content!!}
                    </div>
                  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3">
        ...
        <a href="#" class="btn btn-default btn-lg">More Galleries</a>
      </div>
